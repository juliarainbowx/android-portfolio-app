...
public class Contact extends AppCompatActivity {
    public static String FACEBOOK_URL = "https://www.facebook.com/juliarainbowx";
    ...
    public void onCall(View v) {
        ...
        if (isReadStorageAllowed()) {
            ...
            Intent intent = new Intent(Intent.ACTION_CALL, Uri.parse("tel:" + "89118263611"));
    ...
    public void onGithub(View v){
        ...
        String url = "https://github.com/juliarainbowx";
    ...
    public void onFacebook(View v){
        ...
        String url = "https://www.facebook.com/juliarainbowx";
        Intent i = new Intent(Intent.ACTION_VIEW);
        i.setData(Uri.parse(url));
        startActivity(i);
    }
    public void onInsta(View v){
        ...
        Uri uri = Uri.parse("http://instagram.com/juliarainbowx");
